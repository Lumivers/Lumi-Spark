...
namespace LSTags
{
	...
	LUMI_SPARK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_State_Downed);   // 倒地匍匐流血状态
	LUMI_SPARK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_State_Reviving); // 救援/被救援中
	LUMI_SPARK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_State_Stunned);  // 破盾虚弱/瘫痪硬直
